...
#include "nonlinear_magnetostatic_formulation.hpp"
...
NLMagnetostaticFormulation::NLMagnetostaticFormulation(
  ...
  : NLStaticsFormulation(magnetic_reluctivity_name, magnetic_vector_potential_name),
    _magnetic_permeability_name(std::move(magnetic_permeability_name))
{
}

void
NLMagnetostaticFormulation::RegisterMagneticFluxDensityAux(
    const std::string & b_field_name, const std::string & external_b_field_name)
{
  //* Magnetic flux density, B = ∇×A
...
void
NLMagnetostaticFormulation::RegisterMagneticFieldAux(const std::string & h_field_name,
...
void
NLMagnetostaticFormulation::RegisterLorentzForceDensityAux(const std::string & f_field_name,
...
void
NLMagnetostaticFormulation::RegisterCoefficients()
{
