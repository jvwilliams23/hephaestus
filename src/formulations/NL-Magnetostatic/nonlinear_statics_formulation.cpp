...
// a1(u, u') = (α∇×u, ∇×u')
// b1(u') = (s0, u') + <(α∇×u) × n, u'>
#include "nonlinear_statics_formulation.hpp"
...
NLStaticsFormulation::NLStaticsFormulation(std::string alpha_coef_name, std::string h_curl_var_name)
  : _alpha_coef_name(std::move(alpha_coef_name)), _h_curl_var_name(std::move(h_curl_var_name))
{
}

void
NLStaticsFormulation::ConstructJacobianPreconditioner()
{
...
void
NLStaticsFormulation::ConstructJacobianSolver()
{
...
void
NLStaticsFormulation::ConstructOperator()
{
  auto new_operator = std::make_unique<hephaestus::NLStaticsOperator>(
...
void
NLStaticsFormulation::RegisterGridFunctions()
{
...
void
NLStaticsFormulation::RegisterCoefficients()
{
...
NLStaticsOperator::NLStaticsOperator(hephaestus::Problem & problem,
...
void
NLStaticsOperator::SetGridFunctions()
{
...
void
NLStaticsOperator::Init(mfem::Vector & X)
{
...
*/
void
NLStaticsOperator::Solve(mfem::Vector & X)
{
  spdlog::stopwatch sw;
